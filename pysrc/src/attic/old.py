...
def buildmessage(d):
	"""
	d is dictionnary with keys stdout stderr compileerror
	>>> buildmessage({"compileerror":" pas bien ça","stdout":" ca a eu lieu","stderr":" erreur pas glop"})
	"\\n\\n# Erreur de compilation\\n\\n pas bien ça\\n\\n# Execution \\n\\n ca a eu lieu\\n\\n# Execution d'exécution \\n\\n erreur pas glop"
	"""
	message = ""
	if "compileerror" in d:
		message = "\n\n# Erreur de compilation\n<div class="pl_compileerror">\n"+ d['compileerror'] +"</div>"
	if "stdout" in d:
		message += "\n\n# Execution \n<div class="pl_stdout">\\n" + d['stdout'] +"</div>"
	if "stderr" in d:
		message += "\n\n# Execution d'exécution \n<div class="pl_stderr">\\n" + d['stderr']+"</div>"
