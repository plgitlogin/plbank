...
if "42" in lignes:
		failure(" **42** est un entier est donc pour ne pas avoir d\'ambiguïté entre des valeur entière et des identificateurs les valeurs entières ne sont pas des identificateurs.")
